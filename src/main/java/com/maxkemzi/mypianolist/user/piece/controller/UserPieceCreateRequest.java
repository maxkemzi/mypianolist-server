...
public class UserPieceCreateRequest {
	...
	protected UserPieceCreateRequest() {
	}

	public UserPieceCreateRequest(Integer score, UserPieceStatus status, LocalDate startedAt, LocalDate finishedAt,
			UUID pieceId) {
		this.score = score;
		this.status = status;
